...
public class FixDebugSeven4
{
   public static void main(String[] args)
   {
      ...
      //String letterLength and Integer letterCount created to get accurate count of letters, ignoring all spaces
      String letterLength = aString.replace(" ", "");
      int letterCount = letterLength.length();
